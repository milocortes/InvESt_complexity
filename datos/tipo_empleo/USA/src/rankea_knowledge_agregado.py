...
##-------------------------------------------##
##-------------------------------------------##
## AGREGACIÓN A KNOWLEDGE
##-------------------------------------------##
##-------------------------------------------##

knowledge["Element ID"] = knowledge[ "Element ID"].apply(lambda x : x[:3])
skills = knowledge.copy()
...
skills_ciiu_2d_3d.to_csv("knowledge_ciiu_2d_3d.csv", index = False)
...
skills_ciiu_4d.to_csv("knowledge_ciiu_4d.csv", index = False)
