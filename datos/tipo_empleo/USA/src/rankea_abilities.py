...
skills_completo = occ_ciiu.merge(right=abilities[["O*NET-SOC Code", "Element ID", "Scale ID", "Data Value"]], how="inner", left_on="occ_code", right_on="O*NET-SOC Code")
...
skills_ciiu_2d_3d["element_name_3d"]= skills_ciiu_2d_3d.skill_id.apply(lambda x : x[:5]).replace({i:j for i,j in elementos[["Element ID", "Element Name"]].to_records(index = False)})
skills_ciiu_2d_3d["element_name_2d"]= skills_ciiu_2d_3d.skill_id.apply(lambda x : x[:3]).replace({i:j for i,j in elementos[["Element ID", "Element Name"]].to_records(index = False)})

skills_ciiu_2d_3d.columns = ["ciiu", "element_id", "element_metrica", "element_name","ciiu_label", "ranking", "scale_id", "element_name_3d", "element_name_2d"]
skills_ciiu_2d_3d.to_csv("abilities_ciiu_2d_3d.csv", index = False)
...
skills_ciiu_4d["element_name_3d"]= skills_ciiu_4d.skill_id.apply(lambda x : x[:5]).replace({i:j for i,j in elementos[["Element ID", "Element Name"]].to_records(index = False)})
skills_ciiu_4d["element_name_2d"]= skills_ciiu_4d.skill_id.apply(lambda x : x[:3]).replace({i:j for i,j in elementos[["Element ID", "Element Name"]].to_records(index = False)})

skills_ciiu_4d.columns = ["ciiu", "element_id", "element_metrica", "ranking", "element_name",  "scale_id", "element_name_3d", "element_name_2d"]
skills_ciiu_4d.to_csv("abilities_ciiu_4d.csv", index = False)
